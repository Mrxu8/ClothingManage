...
<body class="easyui-layout">
	...
	<div data-options="region:'north',border:false" style="height:60px;background:#B3DFDA;padding:10px">
		...
		<!-- 管理员登录信息显示 -->
		<span style="float:right;width:200px;height:40px;background-color:#e7f0ff;text-align:center;margin-right:30px;line-height:40px">
			<img src="${sessionScope.managers.manager_img}" style="width:30px;height:30px;border:1px solid blue;border-radius:15px;position:relative;top:6px;"/>
			&nbsp;欢迎您!${sessionScope.managers.manager_nickname}&nbsp;&nbsp;&nbsp;<a href="admin/ManagerAction!logOut.action">注销</a>
		</span>
		
		<span style="float:right;width:40px;height:40px;background-color:#e7f0ff;margin-right:5px;">
			<img alt="" src="images/message.png" style="width:40px;height:40px;">
		</span>
	</div>
	<!-- 功能菜单部分 -->
